...
export default class TopicDetails extends Component{
    constructor(props){
        ...
        this.state={
            isloading:true,
            isloadErr:false,
            url:'http://bbs.reactnative.cn/topic/'+this.props.topicId+'/'+this.props.title
        }
    }
  ...
  render(){
    ...
    return (
      ...
      <PageHeader leftPart={leftPart} pageTitle="优选圈详情" clickFn={this.goBack}>
      </PageHeader>
      ...
      >
          <WebView
            ...
            style={{width:w_width,height:w_height-60}}
